const shortcut = {
    ...
    <div class='py-container'> \
        <div class='shortcut'> \
           ...
           <ul class='fr'> \
               <li class='f-item'>我的收藏</li> \
               <li class='f-item space'></li> \
               <li class='f-item'><a href='home.html' target='_blank'>大金空调</a></li> \
               <li class='f-item space'></li> \
               <li class='f-item'>售后</li> \
               <li class='f-item space'></li> \
               <li class='f-item'>联系我们</li> \
               <li class='f-item space'></li> \
               <li class='f-item'>预定请点击</li> \
               <li class='f-item space'></li> \
